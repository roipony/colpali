...
def search(query: str, ds, images, top_n: int):
    ...
    return f"Top {top_n} relevant pages are {top_indices}", top_images
...
with gr.Blocks() as demo:
    ...
    search_button.click(search, inputs=[query, embeds, imgs, top_n_dropdown], outputs=[message2, output_imgs])

if __name__ == "__main__":
    demo.queue(max_size=10).launch(debug=True, server_name="0.0.0.0", server_port=7860, share=True)
